...
uniqueJons.includes("is-even") && console.log("You are using is-even! Did you know it relies on is-odd?!?\n");

uniqueJons.includes("is-odd") && console.log("You are using is-odd! number % 2 === 0 is very hard to test.\n");
